            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="products.php" class="logo logo-dark">
                            <span class="logo-sm">
                        ...
                        <a href="products.php" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="assets/images/logo-sm.png" alt="" height="22">
                            </span>
                            <span class="logo-lg">
...
$countProductQuery = "SELECT COUNT(*) AS Products FROM products WHERE shopid=$shopid";
$result = mysqli_query($conn, $countProductQuery);

// Check if query executed successfully
if ($result) {
$row = mysqli_fetch_assoc($result);
$totalproduct = $row['Products'];
} else {
// Handle error if query fails
$product = 0; // Set default value if query fails
}
...
<h3 class="text-purple mt-2"><?php echo $totalproduct; ?></h3>
Total Products
</div>
</div>
</div>
...
<?php
                    ...
                    $showproduct = "SELECT `id`,`image`, `name`, `price`,   `shopID`,`stock`,`status`,`category` FROM products WHERE shopID=$shopid";
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class='btn btn-success'> <a href='update2.php?id=$id'>Edit</a></button>" 
                                        . "</td>
                                    </tr>";
                                                        $count++;
                                                    }
