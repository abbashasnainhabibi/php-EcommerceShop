            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="d-none d-sm-block ms-2">
                        <h4 class="page-title font-size-18">Dealer panel</h4>
                    </div>
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        <li class="menu-title">Dealer panel</li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="index.php">All employees</a></li>
                                <ul class="sub-menu" aria-expanded="false">
        ...
        <div class="main-content">
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    $sql1 = "select id from shop where dealerID='$row[0]'";
                    $runquery2 = mysqli_query($conn, $sql1);
...
<?php
// Include the database connection file or initialize $conn variable
include("../connection.php");

// Assuming $shopid is already defined correctly, if not, fetch it from session or elsewhere

// Query to count the number of registered employees
$countEmployeesQuery = "SELECT COUNT(*) AS totalEmployees FROM employees WHERE shopid=$shopid";
$result = mysqli_query($conn, $countEmployeesQuery);
...
$totalEmployees = 0; // Set default value if query fails
}
...
<h3 class="text-purple mt-2"><?php echo $totalEmployees; ?></h3>
Registered employees
    ...
    <button class="btn btn-primary whitetext"><a style="color:white !important"
                            href="createemployee.php">Add Employee</a></button>

<?php
                    $showemployee = "SELECT `id`, `email`, `password`, `shopid` FROM `employees` WHERE shopid=$shopid";
                    $row = mysqli_query($conn, $showemployee);
