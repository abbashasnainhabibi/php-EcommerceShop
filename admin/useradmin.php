            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="useradmin.php" class="waves-effect">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="proadmin.php">All product's</a></li>
                                <ul class="sub-menu" aria-expanded="false">
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card text-center">
                                <div class="mb-2 card-body text-muted">
                                    <h3 class="text-purple mt-2">4</h3> Total Registered User's
                                </div>
                            </div>
                        </div>
                    ...
                    <button class="btn btn-primary whitetext"><a style="color:white !important"
                            href="createuser.php">Add User</a></button>
                    <!-- <h1>signup.php is not made</h1> -->
                    ...
                    $showuser = "SELECT `id`, `Email`, `Pass`, `RoleID`, `FName`, `LName`, `Gender`, `Contact` FROM  users ";
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <table class="table mt-4 mb-0 table-centered table-nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($data = mysqli_fetch_array($row)) {
                                                        ...
                                                        $roleid = $data['RoleID'];
                                                        $sql = "SELECT RoleName FROM role WHERE id=$roleid";
                                        ...
                                        <td>" . $data['Gender'] . "</td>
                                        <td>" . $data['Contact'] . "</td>
                                        <td>" . "<button class='btn btn-danger'> <a href='delete2.php?id=$id'>Delete</a></button>
