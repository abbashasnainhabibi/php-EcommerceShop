            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="d-none d-sm-block ms-2">
                        <h4 class="page-title font-size-18">order Details</h4>
                    </div>
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="adminorder.php" class="waves-effect">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                <li><a href="proadmin.php">All products's</a></li>
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card text-center">
                                <div class="mb-2 card-body text-muted">
                                    <h3 class="text-info mt-2">9</h3> Total Order's 
                                </div>
                            </div>
                        </div>
                    ...
                    <button class="btn btn-primary whitetext"><a style="color:white !important"
                            href="createorder.php">Add order</a></button>
                    <!-- end row -->
                    ...
                    $showproduct = "SELECT `orderno`, `customername`, `product`,`totalprice`, `date`, `customernumber`, `addressDetail`, `quantity`,`billing method` FROM `order`";
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <td>" .
                                         "<button class='btn btn-danger bett'> <a href='deleteorder.php?id=$id'>Delete</a></button>
                                       " 
                                        . "</td>
                                    </tr>";
                                                        $count++;
